...
import { generateAccessToken, generateRefreshToken, verifyToken } from "../../infrastructure/jwt/jwt.service";
import { TokenRepository } from "./token.repository";
import { generateCode, Time } from "../../shared/utils";
import { RecoveryCodesRepository } from "./recoveryCodes.repository";
import { hashPassword, verifyPassword } from "../../shared/password";
import { Token } from "../../infrastructure/jwt/TokenType";
...
export class AuthService {
    ...
    async changePassword(accessToken: string, oldPassword: string, newPassword: string): Promise<void> {
        ...
        const isPasswordValid: boolean = await verifyPassword(user.password, oldPassword);
